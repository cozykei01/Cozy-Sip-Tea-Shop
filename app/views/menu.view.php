            ...
            <?php if(isset($products) && !empty($products)): ?>
                ...
                <div class="product-card" data-id="<?php echo htmlspecialchars($product['product_id']); ?>" data-name="<?php echo htmlspecialchars($product['product_name']); ?>" data-price="<?php echo htmlspecialchars($product['price']); ?>" data-img="<?php echo $img; ?>" data-points="<?php echo htmlspecialchars($product['earned_point_value']); ?>">
                    ...
                    <div class="product-info">
                        ...
                        <p class="product-desc">+<?php echo htmlspecialchars($product['earned_point_value']); ?> Pts | Qty: <span id="product-qty-<?php echo $product['product_id']; ?>"><?php echo htmlspecialchars($product['quantity']); ?></span></p>
